...
void loop() //This code is looped forever
{
  if (updateSensorData)  //Keep the updating of data as a separate task
  {
    ...
    mySensor.updateGyro();         // LR Update Gyro
...
//    Serial.print(mySensor.readGravAccelZ());  //Gravity Acceleration Z-Axis data
    ...
    Serial.print(" rate gyro Z: ");
    Serial.print(mySensor.readGyroZ());   //yaw rate
    Serial.println("deg/sec");

    Serial.print(" rate gyro Y: ");
    Serial.print(mySensor.readGyroY());   //yaw rate
    Serial.println("deg/sec");

    Serial.print(" rate gyro X: ");
    Serial.print(mySensor.readGyroX());   //yaw rate
    Serial.println("deg/sec");
