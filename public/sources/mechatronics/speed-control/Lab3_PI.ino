// Akwasi D. Akosah
// ENGS 147
// Lab 3 -- Proportional-Integral Control
...
float referenceVel = 90.0;
float compGain = 0.1;
float a = 0.106;
float b = 0.094;
int STREAMPERIOD = 20000; //20ms
...
//***************************************
  ...
  while (counts <= 100)
  {
    ...
    if ((currTime - prevTime) >= STREAMPERIOD)
    {
      ...
      controlEffort = controlSigVoltArr[counts - 1] + a*errorSig - b*errorSigArr[counts -1];
